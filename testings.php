...
heredoc;
                ...
                for ($c = 0; $c < count($meta); $c++) {
                    ...
                    echo "modal-id$c " . count($meta);
                    echo "HERE0";
                    // $g = "div id='modal-id$c' class='modal modal-fx-fadeInScale'";
                    // echo $g;
                    ...
                    if (isset($cd) && $valid == true) {
                        $sql = "SELECT * from comments where code = '" . $cd . "' AND mal_ID='{$malid}' ";
                        if ($comments = mysqli_query($mysqli, $sql)) {
                            echo "<div class=\"is-small-space hideme\"><br><br><br></div>";
                            echo "<section class=\"hero\">";
                            echo "<div class=\"hero-body card\">";
                            // echo "<div class=\"container \">";
                            echo "<h1 class=\"title\">";
                            echo "Comments and Reviews";
                            echo "</h1>";
                            echo "<h6 class=\"subtitle\">";
                            echo "&nbsp &nbsp See what others have to say";
                            echo "</h6>";
    ...
    <div class="is-centered columns hideme">
        <article class="media hideme" style="margin-top: 60px;">
            <figure class="media-left">
                <div class="container" style="position: relative;">
                    ...
                    <p class="image is-96x96">
                        <img class="avatar" id="avatar" src="<?php
                ...
                <div class="columns is-gapless">
                    <div class="column is-narrow">
                        <div class="select is-small avs " style="margin-right:15px;"> <select id="avs">
            ...
            <form action="planComment.php" method="POST">
                <input type="hidden" name="avatar" class="avatarPOST" id="avatarPOST" value="<?php
                ...
                <div class="media-content">
                    ...
                    <div class="field">
                        <p class="control">
                            ...
                            <input class="input is-expanded" type="text" maxlength="20" name="name" value="" placeholder="What shall we call you?">></input>
                        </p>
                    </div>
                    <div class="field">
                        <p class="control">
